...
class FinancialDiffusionModel(nn.Module):
    def __init__(self, time_dim=512, cond_dim=64, d_model=128):
        ...
        self.cond_embedding = nn.Sequential(
            ...
            nn.ReLU(),
            nn.LayerNorm(cond_dim),  # Added LayerNorm
        ...
        self.transformer = nn.TransformerEncoder(
            nn.TransformerEncoderLayer(d_model=d_model, nhead=8, dim_feedforward=1024, batch_first=True),  # Increased feedforward
            num_layers=10)
    ...
    def forward(self, x, t, cond):
        ...
        cond_emb = self.cond_embedding[3](cond_emb)  # [batch, seq_len, cond_dim]
        cond_res = cond_emb
        cond_emb, _ = self.cond_embedding[4](cond_emb, cond_emb, cond_emb)  # [batch, seq_len]

System: seq_len, cond_dim = 64
        ...
        class FinancialDiffusionModel(nn.Module):
            ...
            def forward(self, x, t, cond):
                ...
                cond_emb = self.cond_embedding[3](cond_emb)  # [batch, seq_len, cond_dim]
                cond_res = cond_emb
                cond_emb, _ = self.cond_embedding[4](cond_emb, cond_emb, cond_emb)  # [batch, seq_len, cond_dim]
        ...
        class Diffusion:
            def __init__(self, num_timesteps, beta_start=0.00005, beta_end=0.003):  # Reduced beta_end
