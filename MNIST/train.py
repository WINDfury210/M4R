...
def train(model, dataloader, diffusion, optimizer, scheduler, device, num_epochs=1000):
    ...
    torch.save(model.state_dict(), "models/cond_hrd_style_mnist_64.pth")
    print("Model saved to models/cond_hrd_style_mnist_64.pth")
...
if __name__ == "__main__":
    dataset = load_and_cluster_mnist_data(num_classes=10, num_clusters_per_class=5)
